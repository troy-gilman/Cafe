...
//    } else {
//        Vertex* duplicateVertex = new Vertex(previousVertex->position, (i32) vertices.size());
...
//            Vertex* vertex = new Vertex(position, (i32) vertices.size());
...
//                return false;
//            }
//            std::cout << "Face: " << vertexIndex[0] << "/" << uvIndex[0] << "/" << normalIndex[0] << " "
//                << vertexIndex[1] << "/" << uvIndex[1] << "/" << normalIndex[1] << " "
//                << vertexIndex[2] << "/" << uvIndex[2] << "/" << normalIndex[2] << std::endl;
